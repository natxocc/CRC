...
class db
{
    ...
    function reportRecibos($post)
    {
        ...
        foreach ($result['data']['Urgentes'] as $key => $value) {
            $post['message'] .= "<li>" . $lang['Fecha'] . $value['FechaEfecto'] . " || " . $lang['Recibo'] . "<a href='http://totsegur.synology.me/recibos/" . $value['CodigoRecibo'] . "></a>" . $value['CodigoRecibo'] . " || " . $lang['Poliza'] . $value['CodigoPoliza'] . " || " . $lang['Cliente'] . $value['NombreTomador'] . "</li>";
        }
